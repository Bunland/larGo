...
type LarObject = { color: (colorType: ColorType, ...data: any[]) => undefined, version: string }
type ConsoleObject = { time: (label?: string) => undefined, timeEnd: (label?: string) => undefined, log: (...data: any[]) => undefined, clear: () => undefined, error: (message: string) => undefined, assert: (expression: boolean, ...obj: any[]) => undefined }
